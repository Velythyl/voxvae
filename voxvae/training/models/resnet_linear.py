...
class Autoencoder(nn.Module):
    def __init__(self, input_shape, latent_size, num_classes):
        ...
        self.decoder = nn.Sequential(
            ...
            nn.ConvTranspose3d(128, 128, kernel_size=3, stride=2, padding=1, output_padding=1),  # (128, D/8, H/8, W/8) -> (128, D/4, H/4, W/4)
            nn.LeakyReLU(),
            ResidualBlock(128, 64),
            nn.ConvTranspose3d(64, 64, kernel_size=3, stride=2, padding=1, output_padding=1),  # (64, D/4, H/4, W/4) -> (64, D/2, H/2, W/2)
            nn.LeakyReLU(),
            ResidualBlock(64, 32),
            nn.ConvTranspose3d(32, num_classes, kernel_size=3, stride=2, padding=1, output_padding=1),  # (32, D/2, H/2, W/2) -> (num_classes, D, H, W)
        )
